...
- **Statistics**
  ...
  - 2-4 April 2025: Analysing contours in phonetic data: Dynamic analysis hands-on workshop using R. [[url]](https://site.unibo.it/akid/en/agenda/analysing-contours-in-phonetic-data-dynamic-analysis-hands-on-workshop-using-r)

      Hosted by Prof. Chiara Meluzzi and Dr Yuka Naito (University of Milan, the AKiD project - PRIN 2022 PNRR). 

- **Ultrasound tongue imaging**

  - 12 September 2025: One-day training on ultrasound data collection. 

      Hosted by Dr Sam Kirkham (Lancaster University).

  - 23-25 September 2024: Basqueing in ultrasound: Hands-on workshop on data collection and analysis methods of ultrasound tongue imaging. 

      Hosted by Dr Ander Egurtzegi and Iñigo Urrestarazu (iker-CNRS).
...
- **LING325 Topics in Phonetic and Phonological Theory** 
  ...
  - Main responsibilities include: delivering small group seminars, holding weekly office hours, responding to queries from students, and marking and providing feedback on coursework essays
...
- **LING327 Advanced English Phonetics** 
  ...
  - Main responsibilities include: delivering small group seminars, holding weekly office hours, responding to queries from students (including discussing project ideas for their experimental phonetics coursework projects), and marking and providing feedback on coursework essays
...
- **LING103 Linguistics** 
  ...
  - Main responsibilities include: writing and delivering lectures, writing seminar materials and guidance for associate lecturers, holding weekly office hours, responding to queries from students, and developing/marking online quizzes. 

- **LING221 Sounds of the world's languages** 

  - Seminar tutor: 2nd year UG, Lancaster University (2022-24)
...
<br>
  ...
  - September 2023 at Lancaster University

  - instructor: 13 incoming postgraduate students
  
  - classroom teaching, weekly one-to-one tutoring, essay marking and providing detailed feedback on their writing. 
